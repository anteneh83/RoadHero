        ...
        try {
            ...
            if (tech && !tech.is_active) {
                try {
                    ...
                    console.log("[Job Queue] Could not auto-activate technician:", e);
                }
            }
                                ...
                                <div className="space-y-3">
                                    ...
                                    >
                                        ...
                                        {technicians.map(tech => (
                                            <option key={tech.id} value={tech.id} className="bg-white dark:bg-[#0A0A0A] text-gray-900 dark:text-white p-2">
                                                {tech.full_name} {!tech.is_active && '(Offline)'}
                                            </option>
                                        ))}
                                    </select>
                                </div>
