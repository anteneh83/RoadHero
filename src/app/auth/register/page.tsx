                ...
                return (
                    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        <section className="space-y-5">
                            <h3 className="text-lg font-black text-gray-900 dark:text-white border-l-4 border-accent pl-4 tracking-tight">Account Identity</h3>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                                <div className="space-y-2">
                                    <label className="text-[11px] font-black text-gray-600 dark:text-gray-400 uppercase tracking-widest ml-1">Full Name</label>
                                    <input type="text" placeholder="Abebe Bikila" className="w-full px-5 py-3.5 rounded-[16px] border border-gray-100 dark:border-white/10 bg-gray-50 dark:bg-white/[0.02] dark:text-white focus:bg-white dark:focus:bg-white/5 focus:border-primary dark:focus:border-accent transition-all outline-none font-medium text-sm placeholder:text-gray-300 dark:placeholder:text-gray-700" />
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <input type="email" placeholder="abebe@example.com" className="w-full px-5 py-3.5 rounded-[16px] border border-gray-100 dark:border-white/10 bg-gray-50 dark:bg-white/[0.02] dark:text-white focus:bg-white dark:focus:bg-white/5 focus:border-primary dark:focus:border-accent transition-all outline-none font-medium text-sm placeholder:text-gray-300 dark:placeholder:text-gray-700" />
                                </div>
                            </div>
                        </section>
                        ...
                        <section className="space-y-5">
                            ...
                            <div className="space-y-5">
                                <div className="space-y-2">
                                    ...
                                    <input type="text" placeholder="Abyssinia Motors" className="w-full px-5 py-3.5 rounded-[16px] border border-gray-100 dark:border-white/10 bg-gray-50 dark:bg-white/5 dark:text-white focus:bg-white dark:focus:bg-white/5 focus:border-primary dark:focus:border-accent transition-all outline-none font-bold text-sm" />
                                </div>
                                        ...
                                        {['Mechanical Repair', 'Towing', 'Tire Change', 'Fuel Delivery', 'Electrician'].map((cat) => (
                                            <button
                                                ...
                                                className={cn(
                                                    ...
                                                    ["Mechanical Repair", "Towing"].includes(cat)
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative group">
                                        <input type="text" placeholder="0045623XXX" className="w-full px-5 py-3.5 rounded-[16px] border border-gray-100 dark:border-white/10 bg-gray-50 dark:bg-white/[0.02] dark:text-white focus:bg-white dark:focus:bg-white/5 focus:border-primary dark:focus:border-accent transition-all outline-none font-bold text-sm" />
                        ...
                        <div className="space-y-6 shrink-0 py-2">
                            <div className="space-y-2">
                                ...
                                <div className="relative group">
                                    ...
                                    <input type="text" placeholder="Bole, Addis Ababa" className="w-full pl-11 pr-4 py-3.5 rounded-[16px] border border-gray-100 dark:border-white/10 bg-white dark:bg-white/10 dark:text-white focus:border-primary dark:focus:border-accent outline-none text-[12px] font-black shadow-sm focus:ring-4 focus:ring-primary/5 transition-all transition-colors" />
                                </div>
                            </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div className="space-y-3">
                                    ...
                                    <input type="file" ref={licenseRef} className="hidden" onChange={(e) => setBusinessLicense(e.target.files?.[0]?.name || null)} />
                                    <div
                                    ...
                                    >
                                        <div className={cn(
                                            ...
                                            businessLicense ? "bg-green-500 text-white" : "bg-white dark:bg-white/10 text-primary dark:text-accent"
                                        )}>
                                            {businessLicense ? <Check size={24} strokeWidth={3} /> : <Upload size={24} />}
                                        </div>
                                ...
                                <div className="space-y-3">
                                    ...
                                    <input type="file" ref={tinRef} className="hidden" onChange={(e) => setTinCertificate(e.target.files?.[0]?.name || null)} />
                                    <div
                                    ...
                                    >
                                        ...
                                        <div className="h-1 bg-gray-50 dark:bg-white/5 rounded-full overflow-hidden">
                                            <div className={cn("h-full transition-all duration-1000", tinCertificate ? "bg-green-500 w-full" : "bg-primary/20 w-0")} />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <input type="file" ref={ownerIdRef} className="hidden" onChange={(e) => setOwnerId(e.target.files?.[0]?.name || null)} />
                                <div
                                ...
                                >
                                    <div className="w-14 h-14 bg-gray-50 dark:bg-white/5 rounded-[20px] flex items-center justify-center text-gray-300 dark:text-gray-700 group-hover:scale-110 group-hover:bg-primary-dark group-hover:text-white transition-all duration-500">
                                        {ownerId ? <Check size={24} /> : <User size={24} />}
                                    </div>
                        ...
                        <div className="p-8 bg-gray-50/50 dark:bg-white/[0.01] border-t border-gray-100 dark:border-white/5 flex justify-between items-center transition-colors">
                            <button
                                ...
                                className={cn(
                                    ...
                                    currentStep === 1 ? "invisible" : "text-gray-400 hover:text-gray-900 dark:hover:text-white"
                                )}
                            >
                            ...
                            <button
                                ...
                                className="group relative flex items-center gap-3 bg-primary dark:bg-accent hover:bg-primary-dark dark:hover:bg-orange-600 px-10 py-4 rounded-[18px] text-white text-[10px] font-black uppercase tracking-[0.2em] shadow-xl shadow-blue-900/10 dark:shadow-none hover:scale-[1.03] active:scale-95 transition-all overflow-hidden"
                            >
