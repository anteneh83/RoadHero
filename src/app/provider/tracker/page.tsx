...
import { jobService, technicianService, Job, JobStatus, UpdateStatusPayload, FinalizeJobPayload } from '@/services/api.service';
...
export default function JobTrackerPage() {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <div className="p-8 lg:p-12 space-y-8 animate-in fade-in duration-1000 h-full flex flex-col pb-20 relative">
                    ...
                    <div className="flex flex-wrap gap-3">
                        {jobs.map(job => (
                            <button
                                ...
                                className={cn(
                                    "px-5 py-2.5 rounded-2xl text-[10px] font-black uppercase tracking-widest transition-all duration-300 border text-left",
                                    job.id === selectedJobId
                                        ? "bg-primary text-white border-primary shadow-xl shadow-primary/20"
                                        : "bg-white/80 dark:bg-white/5 text-gray-400 dark:text-gray-500 border-white/40 dark:border-white/5 hover:text-gray-900 dark:hover:text-white"
                                )}
                            >
                                ...
                                <span className={cn(
                                    "font-bold text-[8px]",
                                    job.id === selectedJobId ? "text-white/70" : "text-gray-400"
                                )}>
                                    {job.distance || 'Active Request'}
                                </span>
                            </button>
                        ))}
                    </div>
                ...
                {selectedJob && (
                    <>
                        ...
                        <div className="self-end z-[120] w-full max-w-xs px-4 mt-auto">
                            <button
