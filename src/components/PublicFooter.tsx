                ...
                <div className="space-y-4">
                    ...
                    <div className="flex justify-center gap-6">
                        {['Privacy Policy', 'Terms of Service', 'Support Center'].map((item) => (
                            <a key={item} href="#" className="text-[9px] font-black text-gray-500 dark:text-gray-400 uppercase tracking-widest hover:text-primary dark:hover:text-accent transition-colors">
                                {item}
                            </a>
                        ))}
                    </div>
