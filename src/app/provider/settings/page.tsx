                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <div className="relative">
                                        <textarea
                                            rows={2}
                                            defaultValue="Located directly behind Dembel City Center. Gate 2."
                                            onChange={() => setUnsavedChanges(true)}
                    ...
                    <div className="bg-gray-900/95 dark:bg-[#111111]/95 backdrop-blur-md rounded-[20px] p-2 pl-6 shadow-2xl border border-white/10 dark:border-white/5 flex items-center justify-between transition-colors">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                className="px-5 py-2.5 rounded-xl border border-white/20 dark:border-white/10 text-white text-[8px] font-black uppercase tracking-widest hover:bg-white/10 transition-colors"
                            >
                                Discard
                            </button>
                            <button
                                ...
                                className="px-7 py-2.5 rounded-xl bg-accent text-white text-[8px] font-black uppercase tracking-widest shadow-xl shadow-orange-900/40 dark:shadow-none hover:bg-orange-600 dark:hover:bg-accent/80 active:scale-95 transition-all flex items-center gap-2"
                            >
                                <Save size={12} />
                                Save Changes
                            </button>
